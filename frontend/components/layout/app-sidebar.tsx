  ...
  return (
    <aside className="hidden w-72 shrink-0 flex-col border-r border-white/50 bg-[#0f172a] px-6 py-8 text-white lg:flex">
      <div className="mb-10">
        ...
        <h1 className="mt-3 text-2xl font-semibold">Foundation</h1>
        <p className="mt-2 text-sm text-slate-300">Fluxo inicial de autenticação, onboarding, catálogo e estoque.</p>
      </div>
