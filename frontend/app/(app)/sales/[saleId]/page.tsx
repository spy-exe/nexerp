...
export default function SaleDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Card className="p-6">
        <p className="font-mono text-xs uppercase tracking-[0.3em] text-blue-700">Venda</p>
      ...
      <Card className="p-6">
        ...
        <div className="mt-6 grid gap-3">
          {sale.payments.map((payment) => (
            <div key={payment.id} className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-5 py-4">
