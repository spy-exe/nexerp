...
export default function ResetPasswordIndexPage() {
  return (
    <Card className="w-full max-w-xl p-8">
      <p className="font-mono text-xs uppercase tracking-[0.3em] text-blue-700">Reset</p>
      ...
      <Link href="/forgot-password" className="mt-6 inline-block text-sm text-blue-700 hover:underline">
