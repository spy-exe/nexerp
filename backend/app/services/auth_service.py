...
SYSTEM_ROLES: dict[str, list[str]] = {
    ...
    "Vendedor": ["products:read", "categories:read", "stock:read"],
    "Estoquista": ["products:read", "categories:read", "stock:read", "stock:adjust"],
    "Financeiro": ["company:read"],
    "Visualizador": ["company:read", "products:read", "categories:read", "stock:read"],
}
